...
class Modify extends JDialog implements ActionListener
{
   ...
   public Modify(Frame fck,String ckm,Boolean msck,MyTableModel xsxx2,int hang)
   {
	   super(fck,ckm,msck);
	   bq1=new JLabel("               Name      ");
	   bq2=new JLabel("               Phone      ");
	   bq3=new JLabel("               Time    ");
	   bq4=new JLabel("               From     ");
	   bq5=new JLabel("               To     ");
//	   bq6=new JLabel("               Department     ");
	   ...
	   wbk1.setText(  ((String)xsxx2.getValueAt(hang,0)).toString());/////////////////Very Important!
...
//	   wbk6.setText((String)xsxx2.getValueAt(hang,5));
	   ...
	   mb2.setLayout(new GridLayout(5,1));
	   
	   mb1.add(bq1);  mb1.add(bq2);  mb1.add(bq3);
	   mb1.add(bq4);  mb1.add(bq5); 
//	   mb1.add(bq6);
	   
	   mb2.add(wbk1);  mb2.add(wbk2);  mb2.add(wbk3);
	   mb2.add(wbk4);  mb2.add(wbk5);  
//	   mb2.add(wbk6);
...
//				  ct=DriverManager.getConnection("jdbc:odbc:sql server","sa","ydyd4488321");
				  String ss=("update client set Name=?,Time=?,FromWhere=?,ToWhere=? where Phone=?");
